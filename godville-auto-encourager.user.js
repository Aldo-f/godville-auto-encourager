...
var encourager = setInterval( checkHealth, 15000);
...
divx.innerHTML ='<div class="block" id="auto-encourage"><div class="block_h"><span class="l_slot"><span class="b_handle m_hover" style="display: none;" title="Drag to move this block">●</span></span><h2 class="block_title">Auto-Encourager</h2><span class="r_slot"><span class="h_min m_hover" style="display: none;">↑</span></span></div><div class="block_content"><p>I will check for health every 15 seconds and if health is less then 10% I will try to encourage your superhero.</p><div><a style="display: inline;" class="no_link enc_link div_link" id="resume" title="Resume">Resume</a><a style="display: inline;" class="no_link pun_link div_link" id="pause" title="Pause">Pause</a></div></div><div class="line"/></div></div>';
document.getElementById("right_block").appendChild(divx);

document.getElementById("pause").addEventListener("click", pauseEncourager, false);
document.getElementById("resume").addEventListener("click", resumeEncourager, false);
